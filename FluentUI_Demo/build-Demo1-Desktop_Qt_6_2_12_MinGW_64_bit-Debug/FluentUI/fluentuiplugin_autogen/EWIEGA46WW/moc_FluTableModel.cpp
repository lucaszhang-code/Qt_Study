...
#include <memory>
#include "../../../../Demo1/FluentUI/FluTableModel.h"
...
struct qt_meta_stringdata_FluTableModel_t {
    uint offsetsAndSizes[34];
    char stringdata0[168];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_FluTableModel_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_FluTableModel_t qt_meta_stringdata_FluTableModel = {
    {
    ...
    "FluTableModel\0QML.Element\0columnSourceChanged\0"
    "\0rowsChanged\0clear\0getRow\0rowIndex\0"
    "setRow\0row\0insertRow\0removeRow\0rows\0"
    "appendRow\0columnSource\0QList<QVariantMap>\0"
    "rowCount"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_FluTableModel[] = {
...
const QMetaObject FluTableModel::staticMetaObject = { {
    QMetaObject::SuperData::link<QAbstractTableModel::staticMetaObject>(),
    qt_meta_stringdata_FluTableModel.offsetsAndSizes,
    qt_meta_data_FluTableModel,
    qt_static_metacall,
    nullptr,
qt_metaTypeArray<
QList<QVariantMap>, QList<QVariantMap>, int, FluTableModel, void, void

, void, QVariant, int, void, int, QVariant, void, int, QVariant, void, int, int, void, int, void, QVariant
...
void *FluTableModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FluTableModel.stringdata0))
