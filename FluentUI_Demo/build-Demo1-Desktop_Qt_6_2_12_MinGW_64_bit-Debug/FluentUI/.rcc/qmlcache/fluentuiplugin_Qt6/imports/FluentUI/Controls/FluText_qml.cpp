...
0x58,0x6,0x0,0x0,0x34,0x37,0x35,0x36,
...
0x0,0x0,0x0,0x0,0xa8,0xb0,0xc4,0x0,
0x79,0x3e,0xb8,0xe7,0x63,0x24,0x44,0x5f,
0xd1,0x7f,0x39,0x41,0x0,0x0,0x0,0x0,
0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
...
// generate_LoadQmlContextPropertyLookup
aotContext->setInstructionPointer(2);
while (!aotContext->loadTypeLookup(3, &r2)) {
...
aotContext->initGetObjectLookup(4, r2, QMetaType::fromType<bool>());
if (aotContext->engine->hasError())
    return double();
}
}
...
aotContext->initGetEnumLookup(6, QMetaType::fromName("QQuickText *").metaObject(), "RenderType", "NativeRendering");
if (aotContext->engine->hasError())
    return double();
}
{
...
aotContext->initGetEnumLookup(8, QMetaType::fromName("QQuickText *").metaObject(), "RenderType", "QtRendering");
if (aotContext->engine->hasError())
    return double();
}
{
