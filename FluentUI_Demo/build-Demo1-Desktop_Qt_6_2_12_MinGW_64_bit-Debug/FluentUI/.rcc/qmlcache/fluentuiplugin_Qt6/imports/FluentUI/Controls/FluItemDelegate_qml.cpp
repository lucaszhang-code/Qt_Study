...
0x98,0x10,0x0,0x0,0x34,0x37,0x35,0x36,
...
0x0,0x0,0x0,0x0,0xa8,0x8f,0x4a,0xd8,
0xd6,0x12,0x45,0xf7,0x77,0x3f,0xb,0x73,
0xa5,0x61,0x3b,0x8,0x0,0x0,0x0,0x0,
0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
...
aotContext->initGetObjectLookup(20, r2, QMetaType::fromName("QQuickPalette *"));
if (aotContext->engine->hasError())
    return QVariant();
}
}
...
while (!aotContext->getObjectLookup(25, r2, r2_1.data())) {
aotContext->initGetObjectLookup(25, r2, r2_1.metaType());
if (aotContext->engine->hasError())
    return QVariant();
r2_1 = QVariant(aotContext->lookupResultMetaType(25));
}
...
{
aotContext->setInstructionPointer(4);
while (!aotContext->getObjectLookup(41, r2, &r2_2)) {
...
while (!aotContext->loadTypeLookup(42, &r2_1)) {
...
{
void *args[] = { &r2_3, &r10_1, &r11_1, &r12_1, &r13_1 };
const QMetaType types[] = { QMetaType::fromType<QVariant>(), QMetaType::fromType<int>(), QMetaType::fromType<int>(), QMetaType::fromType<int>(), QMetaType::fromType<double>() };
...
while (!aotContext->loadTypeLookup(44, &r2_1)) {
aotContext->initLoadTypeLookup(44);
if (aotContext->engine->hasError())
    return QVariant();
}
{
...
aotContext->initGetObjectLookup(51, r2, QMetaType::fromType<bool>());
if (aotContext->engine->hasError())
    return bool();
}
}
