...
// userMainWindow::userMainWindow(QWidget *parent) : MainWindow(parent) {
//     // 在这里初始化UserMainWindow特定的内容
...
public:
    ...
    // QString fileProduct = "C:\\Users\\Lucas\\Desktop\\Study\\Qt_Study\\Takeaway_System\\data\\products.json";
    ...
    // 存储用户的姓名
    QString userName = "Lucas";
    // 存储用户电话
    QString userContactInfo = "18382243428";

    QString userGender = "男";
    ...
    bool binarySearchDelete(QList<int>& list, int key);
