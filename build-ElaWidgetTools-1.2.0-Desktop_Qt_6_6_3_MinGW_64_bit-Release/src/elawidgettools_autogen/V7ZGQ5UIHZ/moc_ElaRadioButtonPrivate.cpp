...
struct qt_meta_stringdata_CLASSElaRadioButtonPrivateENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSElaRadioButtonPrivateENDCLASS = QtMocHelpers::stringData(
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSElaRadioButtonPrivateENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSElaRadioButtonPrivateENDCLASS_t qt_meta_stringdata_CLASSElaRadioButtonPrivateENDCLASS = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_CLASSElaRadioButtonPrivateENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ElaRadioButtonPrivate::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_CLASSElaRadioButtonPrivateENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSElaRadioButtonPrivateENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSElaRadioButtonPrivateENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *ElaRadioButtonPrivate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSElaRadioButtonPrivateENDCLASS.stringdata0))
