...
struct qt_meta_stringdata_CLASSElaNavigationBarPrivateENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSElaNavigationBarPrivateENDCLASS = QtMocHelpers::stringData(
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSElaNavigationBarPrivateENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSElaNavigationBarPrivateENDCLASS_t qt_meta_stringdata_CLASSElaNavigationBarPrivateENDCLASS = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_CLASSElaNavigationBarPrivateENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ElaNavigationBarPrivate::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_CLASSElaNavigationBarPrivateENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSElaNavigationBarPrivateENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSElaNavigationBarPrivateENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *ElaNavigationBarPrivate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSElaNavigationBarPrivateENDCLASS.stringdata0))
