...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_T_BaseComponents_t::offsetsAndSizes) + ofs), len 
...
const QMetaObject T_BaseComponents::staticMetaObject = { {
    QMetaObject::SuperData::link<ElaScrollPage::staticMetaObject>(),
    qt_meta_stringdata_T_BaseComponents.offsetsAndSizes,
    qt_meta_data_T_BaseComponents,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_T_BaseComponents_t
