...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ElaPromotionCardPrivate_t::offsetsAndSizes) + ofs), len 
...
const QMetaObject ElaPromotionCardPrivate::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_ElaPromotionCardPrivate.offsetsAndSizes,
    qt_meta_data_ElaPromotionCardPrivate,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ElaPromotionCardPrivate_t
