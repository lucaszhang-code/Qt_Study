...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ElaIconButtonPrivate_t::offsetsAndSizes) + ofs), len 
...
const QMetaObject ElaIconButtonPrivate::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_ElaIconButtonPrivate.offsetsAndSizes,
    qt_meta_data_ElaIconButtonPrivate,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ElaIconButtonPrivate_t
, QtPrivate::TypeAndForceComplete<int, std::true_type>, QtPrivate::TypeAndForceComplete<ElaIconButtonPrivate, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
