...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ElaContentDialogPrivate_t::offsetsAndSizes) + ofs), len 
...
const QMetaObject ElaContentDialogPrivate::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_ElaContentDialogPrivate.offsetsAndSizes,
    qt_meta_data_ElaContentDialogPrivate,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ElaContentDialogPrivate_t
