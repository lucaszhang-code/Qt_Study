...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ElaToggleButtonPrivate_t::offsetsAndSizes) + ofs), len 
...
const QMetaObject ElaToggleButtonPrivate::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_ElaToggleButtonPrivate.offsetsAndSizes,
    qt_meta_data_ElaToggleButtonPrivate,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ElaToggleButtonPrivate_t
, QtPrivate::TypeAndForceComplete<int, std::true_type>, QtPrivate::TypeAndForceComplete<ElaToggleButtonPrivate, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
