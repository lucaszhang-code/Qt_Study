...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ElaApplicationPrivate_t::offsetsAndSizes) + ofs), len 
...
const QMetaObject ElaApplicationPrivate::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_ElaApplicationPrivate.offsetsAndSizes,
    qt_meta_data_ElaApplicationPrivate,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ElaApplicationPrivate_t
