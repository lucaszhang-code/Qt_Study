...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ElaScrollPagePrivate_t::offsetsAndSizes) + ofs), len 
...
const QMetaObject ElaScrollPagePrivate::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_ElaScrollPagePrivate.offsetsAndSizes,
    qt_meta_data_ElaScrollPagePrivate,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ElaScrollPagePrivate_t
