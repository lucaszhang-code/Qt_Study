...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ElaSlider_t::offsetsAndSizes) + ofs), len 
...
const QMetaObject ElaSlider::staticMetaObject = { {
    QMetaObject::SuperData::link<QSlider::staticMetaObject>(),
    qt_meta_stringdata_ElaSlider.offsetsAndSizes,
    qt_meta_data_ElaSlider,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ElaSlider_t
