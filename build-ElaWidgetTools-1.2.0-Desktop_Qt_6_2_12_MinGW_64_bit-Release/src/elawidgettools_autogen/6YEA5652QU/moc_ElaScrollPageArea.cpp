...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ElaScrollPageArea_t::offsetsAndSizes) + ofs), len 
...
const QMetaObject ElaScrollPageArea::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_ElaScrollPageArea.offsetsAndSizes,
    qt_meta_data_ElaScrollPageArea,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ElaScrollPageArea_t
, QtPrivate::TypeAndForceComplete<int, std::true_type>, QtPrivate::TypeAndForceComplete<ElaScrollPageArea, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
