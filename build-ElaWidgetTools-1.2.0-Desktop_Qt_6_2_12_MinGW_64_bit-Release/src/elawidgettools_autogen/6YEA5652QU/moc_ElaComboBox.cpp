...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ElaComboBox_t::offsetsAndSizes) + ofs), len 
...
const QMetaObject ElaComboBox::staticMetaObject = { {
    QMetaObject::SuperData::link<QComboBox::staticMetaObject>(),
    qt_meta_stringdata_ElaComboBox.offsetsAndSizes,
    qt_meta_data_ElaComboBox,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ElaComboBox_t
, QtPrivate::TypeAndForceComplete<int, std::true_type>, QtPrivate::TypeAndForceComplete<ElaComboBox, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
