...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ElaMenu_t::offsetsAndSizes) + ofs), len 
...
const QMetaObject ElaMenu::staticMetaObject = { {
    QMetaObject::SuperData::link<QMenu::staticMetaObject>(),
    qt_meta_stringdata_ElaMenu.offsetsAndSizes,
    qt_meta_data_ElaMenu,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ElaMenu_t
, QtPrivate::TypeAndForceComplete<ElaMenu, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
