...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ElaDoubleSpinBox_t::offsetsAndSizes) + ofs), len 
...
const QMetaObject ElaDoubleSpinBox::staticMetaObject = { {
    QMetaObject::SuperData::link<QDoubleSpinBox::staticMetaObject>(),
    qt_meta_stringdata_ElaDoubleSpinBox.offsetsAndSizes,
    qt_meta_data_ElaDoubleSpinBox,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ElaDoubleSpinBox_t
