...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ElaDockWidget_t::offsetsAndSizes) + ofs), len 
...
const QMetaObject ElaDockWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QDockWidget::staticMetaObject>(),
    qt_meta_stringdata_ElaDockWidget.offsetsAndSizes,
    qt_meta_data_ElaDockWidget,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ElaDockWidget_t
