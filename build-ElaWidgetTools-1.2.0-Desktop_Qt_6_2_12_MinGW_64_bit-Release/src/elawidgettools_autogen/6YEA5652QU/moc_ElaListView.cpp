...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ElaListView_t::offsetsAndSizes) + ofs), len 
...
const QMetaObject ElaListView::staticMetaObject = { {
    QMetaObject::SuperData::link<QListView::staticMetaObject>(),
    qt_meta_stringdata_ElaListView.offsetsAndSizes,
    qt_meta_data_ElaListView,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ElaListView_t
