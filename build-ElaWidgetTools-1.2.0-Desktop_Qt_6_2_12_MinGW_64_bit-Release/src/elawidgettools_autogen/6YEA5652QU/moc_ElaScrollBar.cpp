...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ElaScrollBar_t::offsetsAndSizes) + ofs), len 
...
const QMetaObject ElaScrollBar::staticMetaObject = { {
    QMetaObject::SuperData::link<QScrollBar::staticMetaObject>(),
    qt_meta_stringdata_ElaScrollBar.offsetsAndSizes,
    qt_meta_data_ElaScrollBar,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ElaScrollBar_t
, QtPrivate::TypeAndForceComplete<bool, std::true_type>, QtPrivate::TypeAndForceComplete<ElaScrollBar, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
