...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ElaFlowLayout_t::offsetsAndSizes) + ofs), len 
...
const QMetaObject ElaFlowLayout::staticMetaObject = { {
    QMetaObject::SuperData::link<QLayout::staticMetaObject>(),
    qt_meta_stringdata_ElaFlowLayout.offsetsAndSizes,
    qt_meta_data_ElaFlowLayout,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ElaFlowLayout_t
