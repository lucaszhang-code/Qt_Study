...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ElaExponentialBlur_t::offsetsAndSizes) + ofs), len 
...
const QMetaObject ElaExponentialBlur::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_ElaExponentialBlur.offsetsAndSizes,
    qt_meta_data_ElaExponentialBlur,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ElaExponentialBlur_t
