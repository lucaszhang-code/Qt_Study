...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ElaRadioButton_t::offsetsAndSizes) + ofs), len 
...
const QMetaObject ElaRadioButton::staticMetaObject = { {
    QMetaObject::SuperData::link<QRadioButton::staticMetaObject>(),
    qt_meta_stringdata_ElaRadioButton.offsetsAndSizes,
    qt_meta_data_ElaRadioButton,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ElaRadioButton_t
