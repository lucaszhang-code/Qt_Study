...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ElaToolBar_t::offsetsAndSizes) + ofs), len 
...
const QMetaObject ElaToolBar::staticMetaObject = { {
    QMetaObject::SuperData::link<QToolBar::staticMetaObject>(),
    qt_meta_stringdata_ElaToolBar.offsetsAndSizes,
    qt_meta_data_ElaToolBar,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ElaToolBar_t
