...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ElaNavigationView_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_ElaNavigationView_t qt_meta_stringdata_ElaNavigationView = {
    ...
    "\0QModelIndex\0index\0onCustomContextMenuRequested\0"
    "pos"
};
...
const QMetaObject ElaNavigationView::staticMetaObject = { {
    QMetaObject::SuperData::link<QTreeView::staticMetaObject>(),
    qt_meta_stringdata_ElaNavigationView.offsetsAndSizes,
    qt_meta_data_ElaNavigationView,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ElaNavigationView_t
, QtPrivate::TypeAndForceComplete<ElaNavigationView, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<const QModelIndex &, std::false_type>
