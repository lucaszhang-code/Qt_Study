...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ElaSuggestDelegate_t::offsetsAndSizes) + ofs), len 
...
const QMetaObject ElaSuggestDelegate::staticMetaObject = { {
    QMetaObject::SuperData::link<QStyledItemDelegate::staticMetaObject>(),
    qt_meta_stringdata_ElaSuggestDelegate.offsetsAndSizes,
    qt_meta_data_ElaSuggestDelegate,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ElaSuggestDelegate_t
