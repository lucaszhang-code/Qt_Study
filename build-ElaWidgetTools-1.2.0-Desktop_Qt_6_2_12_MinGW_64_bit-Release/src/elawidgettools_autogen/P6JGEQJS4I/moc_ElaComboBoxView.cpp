...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ElaComboBoxView_t::offsetsAndSizes) + ofs), len 
...
const QMetaObject ElaComboBoxView::staticMetaObject = { {
    QMetaObject::SuperData::link<QListView::staticMetaObject>(),
    qt_meta_stringdata_ElaComboBoxView.offsetsAndSizes,
    qt_meta_data_ElaComboBoxView,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ElaComboBoxView_t
, QtPrivate::TypeAndForceComplete<ElaComboBoxView, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<const QModelIndex &, std::false_type>
