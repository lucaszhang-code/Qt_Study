...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ElaBaseListView_t::offsetsAndSizes) + ofs), len 
...
const QMetaObject ElaBaseListView::staticMetaObject = { {
    QMetaObject::SuperData::link<QListView::staticMetaObject>(),
    qt_meta_stringdata_ElaBaseListView.offsetsAndSizes,
    qt_meta_data_ElaBaseListView,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ElaBaseListView_t
