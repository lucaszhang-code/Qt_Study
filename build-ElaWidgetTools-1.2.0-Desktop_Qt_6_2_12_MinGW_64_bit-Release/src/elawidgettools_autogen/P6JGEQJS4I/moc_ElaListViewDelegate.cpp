...
struct qt_meta_stringdata_ElaListViewDelegate_t {
    uint offsetsAndSizes[2];
    char stringdata0[20];
};
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ElaListViewDelegate_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_ElaListViewDelegate_t qt_meta_stringdata_ElaListViewDelegate = {
    {
...
static const uint qt_meta_data_ElaListViewDelegate[] = {
...
const QMetaObject ElaListViewDelegate::staticMetaObject = { {
    QMetaObject::SuperData::link<QStyledItemDelegate::staticMetaObject>(),
    qt_meta_stringdata_ElaListViewDelegate.offsetsAndSizes,
    qt_meta_data_ElaListViewDelegate,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ElaListViewDelegate_t
...
void *ElaListViewDelegate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ElaListViewDelegate.stringdata0))
