...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ElaBreadcrumbBarModel_t::offsetsAndSizes) + ofs), len 
...
const QMetaObject ElaBreadcrumbBarModel::staticMetaObject = { {
    QMetaObject::SuperData::link<QAbstractListModel::staticMetaObject>(),
    qt_meta_stringdata_ElaBreadcrumbBarModel.offsetsAndSizes,
    qt_meta_data_ElaBreadcrumbBarModel,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ElaBreadcrumbBarModel_t
