...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ElaSuggestModel_t::offsetsAndSizes) + ofs), len 
...
const QMetaObject ElaSuggestModel::staticMetaObject = { {
    QMetaObject::SuperData::link<QAbstractListModel::staticMetaObject>(),
    qt_meta_stringdata_ElaSuggestModel.offsetsAndSizes,
    qt_meta_data_ElaSuggestModel,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_ElaSuggestModel_t
